...
public class DatePickerTag extends IncludeTag {
    ...
    protected void setAttributes(HttpServletRequest httpServletRequest) {
        httpServletRequest.setAttribute("lifedev:date-picker:name", _name);
        httpServletRequest.setAttribute("lifedev:date-picker:label", _label);
        httpServletRequest.setAttribute("lifedev:date-picker:date", _date);
    }
    ...
    private static final String _PAGE = "/lifedev/date-picker.jsp";
